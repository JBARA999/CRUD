                ...
                <div class="card borde-0 shadow-lg my-4">
                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.store') }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="" class="form-label h5">Quantity</label>
                                <input value="{{ old('sku') }}" type="text" class="@error('sku') is-invalid @enderror form-control form-control-lg" placeholder="Quantity" name="sku">
                                @error('sku')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
